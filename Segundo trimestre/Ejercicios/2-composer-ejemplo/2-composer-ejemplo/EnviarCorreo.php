...
class EnviarCorreo
{
    ...
    public static function enviarCorreo($receptor)
    {
        ...
        try {
            ...
            $mail->Username = "Vuestra dirección de gmail";

            // Password para la autenticación SMTP de aplicaciones de GMAIL           
            $mail->Password = "Vuestra contraseña para aplicaciones, NO sirve la contraseña de la cuenta";

            // Estableciendo como quién se va a enviar el mail
            $emisor = 'vuestra dirección de gmail';
            $mail->setFrom($emisor);

            //Nombre del emisor que aparece en el mensaje
            $mail->FromName = 'Nombre de la aplicación';
            ...
            //Antes hemos establecido todas las condiciones
            $mail->Timeout = 7;
