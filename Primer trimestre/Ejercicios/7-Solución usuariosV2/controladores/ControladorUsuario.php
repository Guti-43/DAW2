...
class ControladorUsuario
{
    ...
    public function anadirUsuario()
    {
        ...
        //Puedo crear un nuevo usuario admin porque conozco las credenciales
        //Si no conozco las credenciales, he perdido la información.
        ...
        self::mostrarVistaPresentacion($usuario, $error, $usuarios);
    }
    ...
    public static function mostrarVistaPresentacion($usuario, $error = '', $usuarios = [])
    {
